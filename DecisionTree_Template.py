...
print('Test Accuracy: %.2f' % metrics.accuracy_score(y_test, y_predicted))
print('Test Recall: %.2f' % metrics.recall_score(y_test, y_predicted))
print('Test Precision: %.2f' % metrics.precision_score(y_test, y_predicted))
print('Test F1: %.2f' % metrics.f1_score(y_test, y_predicted))
...
print('Train Accuracy: %.2f' % metrics.accuracy_score(y_train, y_predicted_train))
print('Train Recall: %.2f' % metrics.recall_score(y_train, y_predicted_train))
print('Train Precision: %.2f' % metrics.precision_score(y_train, y_predicted_train))
print('Train F1: %.2f' % metrics.f1_score(y_train, y_predicted_train))
...
dot_data = export_graphviz(model, feature_names=breastCancer.feature_names[:numberOfFeatures],
                           class_names=breastCancer.target_names, rounded=True, filled=True)
